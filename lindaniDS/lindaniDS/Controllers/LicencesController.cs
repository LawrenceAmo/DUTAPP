            ...
            if (ModelState.IsValid)
            {
                if (upload != null && upload.ContentLength > 0)
                {
                    ...
                    string message = "This message was sent to "+licence.Names+" ' " +licence.Email+ " ' \n " +
                        ...
                        "Hello you booked code "+licence.Code+" Licence. With "+les+" lessons, and your Total Cost is "+cost+" Your Sessions and Lessons will take place from "+licence.BookingDate+" untill "+licence.BookingDate2+"." +
